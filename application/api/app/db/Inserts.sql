USE GatorGuides;
#Replaced password123 with hashed version of existing password.

INSERT INTO User (firstName, lastName, email, password, Type, profilePicture, bio) VALUES
('John', 'Smith', 'john.smith@sfsu.edu', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewY5lW.zjoyIvNiK', 'user', NULL, 'Experienced data structures tutor with 3 years of teaching experience. Specializing in trees, graphs, and algorithms.'),
('Jane', 'Smith', 'jane.smith@sfsu.edu', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewY5lW.zjoyIvNiK', 'user', NULL, 'Patient tutor focusing on programming fundamentals. Love helping beginners understand coding concepts!'),
('Michael', 'Johnson', 'michael.johnson@sfsu.edu', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewY5lW.zjoyIvNiK', 'user', NULL, 'Graduate student specializing in algorithms and data structures. Published researcher with strong teaching background.'),
('Emily', 'Johnson', 'emily.johnson@sfsu.edu', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewY5lW.zjoyIvNiK', 'user', NULL, 'Math enthusiast helping students conquer calculus. Clear explanations and lots of practice problems!'),
('David', 'Williams', 'david.williams@sfsu.edu', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewY5lW.zjoyIvNiK', 'user', NULL, 'Discrete math made easy! Proofs, logic, and set theory explained simply.'),
('Sarah', 'Williams', 'sarah.williams@sfsu.edu', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewY5lW.zjoyIvNiK', 'user', NULL, 'Software engineering professional with industry experience. Agile methodologies and best practices.'),
('Robert', 'Brown', 'robert.brown@sfsu.edu', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewY5lW.zjoyIvNiK', 'user', NULL, 'Physics tutor covering mechanics, electricity, and magnetism. Problem-solving focused approach.'),
('Jessica', 'Davis', 'jessica.davis@sfsu.edu', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewY5lW.zjoyIvNiK', 'user', NULL, 'Coding bootcamp graduate turned tutor. I understand the struggles of learning to code!'),
('James', 'Miller', 'james.miller@sfsu.edu', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewY5lW.zjoyIvNiK', 'user', NULL, 'Computer architecture and organization expert. Assembly language and digital logic specialist.'),
('Ashley', 'Wilson', 'ashley.wilson@sfsu.edu', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewY5lW.zjoyIvNiK', 'user', NULL, 'AI and machine learning tutor. Making complex concepts accessible to everyone.'),
('Christopher', 'Moore', 'chris.moore@sfsu.edu', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewY5lW.zjoyIvNiK', 'user', NULL, 'Data structures wizard! Let me help you ace CSC 220 with clear explanations and practice.'),
('Amanda', 'Taylor', 'amanda.taylor@sfsu.edu', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewY5lW.zjoyIvNiK', 'user', NULL, 'Linear algebra made simple. Matrices, vector spaces, and eigenvalues demystified.'),
('Daniel', 'Anderson', 'daniel.anderson@sfsu.edu', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewY5lW.zjoyIvNiK', 'user', NULL, 'Network protocols and architecture specialist. TCP/IP, routing, and network security.'),
('Jennifer', 'Thomas', 'jennifer.thomas@sfsu.edu', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewY5lW.zjoyIvNiK', 'user', NULL, 'Calculus tutor with a passion for teaching. Limits, derivatives, and integrals explained clearly.'),
('Matthew', 'Jackson', 'matthew.jackson@sfsu.edu', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewY5lW.zjoyIvNiK', 'user', NULL, 'Operating systems tutor covering processes, threads, memory management, and file systems.'),
('Lauren', 'White', 'lauren.white@sfsu.edu', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewY5lW.zjoyIvNiK', 'user', NULL, 'New tutor excited to help! Strong foundation in programming fundamentals.'),
('Andrew', 'Harris', 'andrew.harris@sfsu.edu', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewY5lW.zjoyIvNiK', 'user', NULL, 'Programming languages enthusiast. Functional programming, compilers, and language design.'),
('Brittany', 'Martin', 'brittany.martin@sfsu.edu', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewY5lW.zjoyIvNiK', 'user', NULL, 'Data structures tutor with focus on practical implementation and interview prep.'),
('Joshua', 'Thompson', 'joshua.thompson@sfsu.edu', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewY5lW.zjoyIvNiK', 'user', NULL, 'Numerical methods and scientific computing. MATLAB and computational mathematics.'),
('Samantha', 'Garcia', 'samantha.garcia@sfsu.edu', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewY5lW.zjoyIvNiK', 'user', NULL, 'OOP expert! Classes, inheritance, polymorphism, and design patterns made easy.'),
('Kevin', 'Martinez', 'kevin.martinez@sfsu.edu', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewY5lW.zjoyIvNiK', 'user', NULL, 'Computer organization tutor. CPU design, cache memory, and performance optimization.'),
('Nicole', 'Robinson', 'nicole.robinson@sfsu.edu', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewY5lW.zjoyIvNiK', 'user', NULL, 'Statistics tutor helping students with probability, distributions, and hypothesis testing.'),
('Ryan', 'Clark', 'ryan.clark@sfsu.edu', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewY5lW.zjoyIvNiK', 'user', NULL, 'OS concepts simplified. Scheduling algorithms, deadlocks, and synchronization.'),
('Megan', 'Rodriguez', 'megan.rodriguez@sfsu.edu', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewY5lW.zjoyIvNiK', 'user', NULL, 'Machine learning and neural networks. Theory and practical implementation with Python.'),
('Brandon', 'Lewis', 'brandon.lewis@sfsu.edu', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewY5lW.zjoyIvNiK', 'user', NULL, 'Logic and proofs specialist. Helping students build strong mathematical reasoning skills.'),
('Rachel', 'Lee', 'rachel.lee@sfsu.edu', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewY5lW.zjoyIvNiK', 'user', NULL, NULL),
('Tyler', 'Walker', 'tyler.walker@sfsu.edu', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewY5lW.zjoyIvNiK', 'user', NULL, NULL),
('Stephanie', 'Hall', 'stephanie.hall@sfsu.edu', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewY5lW.zjoyIvNiK', 'user', NULL, NULL),
('Justin', 'Allen', 'justin.allen@sfsu.edu', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewY5lW.zjoyIvNiK', 'user', NULL, NULL),
('Amber', 'Young', 'amber.young@sfsu.edu', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewY5lW.zjoyIvNiK', 'user', NULL, NULL),
('Admin', 'User', 'admin@sfsu.edu', '$2b$12$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36WQoeG6Lruj3vjPGga31lW', 'admin', NULL, NULL),
('Mark', 'Johnson', 'mark.johnson@sfsu.edu', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewY5lW.zjoyIvNiK', 'user', NULL, 'Computer Science student looking for tutoring help.'),
('Lisa', 'Smith', 'lisa.smith@sfsu.edu', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewY5lW.zjoyIvNiK', 'user', NULL, 'Math major seeking calculus support.'),
('Tom', 'Williams', 'tom.williams@sfsu.edu', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewY5lW.zjoyIvNiK', 'user', NULL, NULL);
