...
<div class="min-h-screen bg-neutral-100 py-8">
	<div class="mx-auto max-w-4xl px-4">
		...
		<div class="mb-8 text-center">
			<h1 class="mb-2 text-4xl font-bold text-[#231161]">Register to start studying</h1>
			<p class="text-gray-600">Join our community of peers helping fellow students succeed</p>
		</div>
