...
<div class="min-h-screen bg-neutral-100 flex items-center justify-center p-6">
    <div class="w-full max-w-2xl rounded-2xl bg-white p-8 shadow-xl border border-gray-100">
        <h1 class="mb-2 text-3xl font-bold text-[#231161] text-center">Create your student account</h1>
        ...
        <form class="space-y-4" on:submit|preventDefault={handleSubmit}>
            ...
            <label class="mt-2 flex items-start gap-2 text-xs text-gray-600">
                ...
                />
                <span>
					I agree to the GatorGuides terms of use and understand that my SFSU account may be used for
					verification.
				</span>
            </label>
